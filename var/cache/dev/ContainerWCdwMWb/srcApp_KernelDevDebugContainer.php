...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.secured_area' => ($this->privates['.security.request_matcher.p4VlLPC'] ?? ($this->privates['.security.request_matcher.p4VlLPC'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api')));
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.simple_preauth.secured_area'] ?? $this->load('getSecurity_Authentication_Provider_SimplePreauth_SecuredAreaService.php'));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'JWTAuthBundle' => [
                    'path' => ($this->targetDirs[3].'/vendor/auth0/jwt-auth-bundle/src'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'JWTAuthBundle' => 'Auth0\\JWTAuthBundle\\JWTAuthBundle',
            ...
            'jwt_auth.api_secret' => '',
            'jwt_auth.domain' => 'YOUR_AUTH0_DOMAIN',
            'jwt_auth.api_identifier' => 'http://localhost:8000',
            'jwt_auth.authorized_issuer' => 'https://dev-r351jhve.eu.auth0.com',
            'jwt_auth.secret_base64_encoded' => false,
            'jwt_auth.supported_algs' => [
                0 => 'RS256',
            ],

...
// Returns the private 'App\Repository\SkuRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SkuRepository.php';

return $this->privates['App\\Repository\\SkuRepository'] = new \App\Repository\SkuRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

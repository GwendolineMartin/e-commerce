...
// Returns the private 'App\Repository\ChoiceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ChoiceRepository.php';

return $this->privates['App\\Repository\\ChoiceRepository'] = new \App\Repository\ChoiceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
class __TwigTemplate_df6097ce154dd885b5480326dc4e5941d4cf189b97512577adc74c5c2b5f1e1f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 28, $this->source); })()), "descriptif", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "product/show.html.twig", "/Users/DoLiNe/Documents/w2web502p2/e-commerce/templates/product/show.html.twig");
    }
}
